...
import pl.btbw.core.product.core.roles.ComponentProviderWrapper;
...
public class Product implements Mappable, Updatable {
	...
	public ComponentProviderWrapper componentProvider(List<String> componentAllowed) {
		return new ComponentProviderWrapper(componentAllowed, this);
	}
